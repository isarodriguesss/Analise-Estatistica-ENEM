...
# Statistical difference between men's and women's grades for the Writing grade
...
## Graph illustrating the analysis of grades variance between genders
...
```{r}
meso = read_xlsx('data/mun_messorregiao.xlsx')
...
# Statistical difference between the scores of the mesoregions
...
## Graph illustrating the variance analysis
...
plot(cn_mt,main='Grades of Natural Sciences and Mathematics')
